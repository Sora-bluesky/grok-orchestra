...
- [x] `docs/walkthrough.md` / `docs/walkthrough.ja.md` が存在し、本文中の全コマンドが
      クリーン環境で再現可能
- [x] トランスクリプト抜粋がすべて実採取(Step 1 のログと突合できる) — 2026-07-21 採取
- [x] `git status` に `.agents/logs/` 配下のファイルが現れない(gitignore 維持)
- [x] README 両言語に導線あり、既存行の削除ゼロ
