...
- `scripts/lib/path-normalize.ps1`: shared segment-based path normalization used by lease-paths and verify-job
...
- known limitations recorded (not silently shipped) in `plans/README.md` Follow-up/deferred
