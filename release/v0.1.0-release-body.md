...
- bilingual README: [README.md](https://github.com/Sora-bluesky/grok-orchestra/blob/v0.1.0/README.md) / [README.ja.md](https://github.com/Sora-bluesky/grok-orchestra/blob/v0.1.0/README.ja.md)
...
- GitHub Release body matches the `v0.1.0` section in [CHANGELOG.md](https://github.com/Sora-bluesky/grok-orchestra/blob/v0.1.0/CHANGELOG.md)
